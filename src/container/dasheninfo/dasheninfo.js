    ...
    render() {
        ...
        return (
            <div>
                ...
                <List>
                    <InputItem onChange={val => {this.handleValue('post', val)}}>求职岗位：</InputItem>
                    <TextareaItem autoHeight title="个人介绍:" rows={2} onChange={val => {this.handleValue('info', val)}}></TextareaItem>
                </List>
